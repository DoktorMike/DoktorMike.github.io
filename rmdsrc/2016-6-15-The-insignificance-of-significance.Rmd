...
qplot(x=value, fill=key, data=gather(data.frame(A=rnorm(1000), B=rnorm(1000), C=rnorm(1000))), geom="density", alpha=0.7) + theme_minimal() + scale_fill_brewer(type="qual") + xlim(c(-4.5, 4.5)) + xlab("y") + ylab("Density")
```
